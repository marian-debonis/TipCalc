...
t.originator.getActive() && (enyo.log("New mode: " + t.originator.getContent()), this.mode = t.originator.getContent()), this.compute();
},
splitChanged: function(e, t) {
enyo.log("splitChanged: " + t.content), this.split = t.content, this.compute();
},
percentChanged: function(e, t) {
enyo.log("percentChanged: " + t.content), this.percent = t.content, this.compute();
},
compute: function() {
var e = parseFloat(this.subtotal), t = e * this.percent / 100, n = e + t;
enyo.log("Computed tip: " + t + " computed total: " + n), this.$.tip.setContent(t.toFixed(this.digits)), this.$.total.setContent(n.toFixed(this.digits));
}
});
