...
enyo.path.addPaths({layout: "/Users/yvesdel-medico/GIT/TipCalc/enyo/tools/../../lib/layout/", onyx: "/Users/yvesdel-medico/GIT/TipCalc/enyo/tools/../../lib/onyx/", onyx: "/Users/yvesdel-medico/GIT/TipCalc/enyo/tools/../../lib/onyx/source/"});
...
kind: "FittableColumns",
content: "fittableColumns2",
isContainer: !0,
name: "fittableColumns2",
components: [ {
kind: "Control",
style: "padding: 10px;",
...
this.subtotal = parseFloat(this.$.subtotal.getValue()), isNaN(this.subtotal) && (enyo.log("subtotal NaN"), this.subtotal = 0), this.subtotal = this.subtotal.toFixed(this.digits), enyo.log("Subtotal: " + this.$.subtotal.getValue() + " --> " + this.subtotal), this.$.subtotal.setValue(this.subtotal), this.compute();
},
modeChanged: function(a, b) {
b.originator.getActive() && (enyo.log("New mode: " + b.originator.getContent()), this.mode = b.originator.getContent()), this.compute();
},
splitChanged: function(a, b) {
enyo.log("splitChanged: " + b.content), this.split = b.content, this.compute();
},
percentChanged: function(a, b) {
enyo.log("percentChanged: " + b.content), this.percent = b.content, this.compute();
},
compute: function() {
var a = parseFloat(this.subtotal), b = a * this.percent / 100, c = a + b;
enyo.log("Computed tip: " + b + " computed total: " + c), this.$.tip.setContent(b.toFixed(this.digits)), this.$.total.setContent(c.toFixed(this.digits));
}
});
